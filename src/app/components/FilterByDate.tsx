...
import FilterByCustomDates from "./FilterByCustomDates";
interface FilterByDateListProps {
  period: string; // Ensure it's a string
  svgColor: string;
}

export default function FilterByDate({ period, svgColor }: FilterByDateListProps) {
  ...
  return (
    <div className="relative w-full sm:w-auto sm;mt-0 mt-2">
      <button onClick={handleClick} className="group w-full sm:w-auto bg-white hover:bg-gray-200 flex gap-2 border rounded-sm py-2 px-4 text-black text-base"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={svgColor}><path d="M440-120v-240h80v80h320v80H520v80h-80Zm-320-80v-80h240v80H120Zm160-160v-80H120v-80h160v-80h80v240h-80Zm160-80v-80h400v80H440Zm160-160v-240h80v80h160v80H680v80h-80Zm-480-80v-80h400v80H120Z" /></svg> Filtrar per intervals de temps</button>
      {menu && (
        <div className="absolute top-12 w-full border p-4 z-30 flex flex-col gap-2 bg-white">
